...
interface AdvertisementDesktopProps {
    ad?: AdvertisementResponse;
}

export function AdvertisementDesktop({ ad }: AdvertisementDesktopProps) {
    ...
    if (!ad) {
        return (
            <section className="w-full h-[26.25rem] bg-destructive-foreground flex items-center justify-center">
    ...
    return (
        <section className="w-full h-[26.25rem] overflow-hidden">
            <button
                type="button"
